from tkinter import*
import tkinter.font as font #untukmenggantifont
import math
...
#fungsimembuatbutton
btn  = Button(root,text="1",padx = 30,bg="green",fg="white", pady = 20,command=lambda:cetak(1))
btn2  = Button(root,text="2",padx = 30,bg="blue",fg="red", pady = 20,command=lambda:cetak(2))
btn3  = Button(root,text="3",padx = 30,bg="red",fg="yellow", pady = 20,command=lambda:cetak(3))
btn4  = Button(root,text="4",padx = 30,bg="white",fg="pink", pady = 20,command=lambda:cetak(4))
btn5 = Button(root,text="5",padx = 30,bg="purple",fg="aqua", pady = 20,command=lambda:cetak(5))
btn6  = Button(root,text="6",padx = 30,bg="orange",fg="red", pady = 20,command=lambda:cetak(6))
btn7  = Button(root,text="7",padx = 30,bg="yellow",fg="black", pady = 20,command=lambda:cetak(7))
btn8  = Button(root,text="8",padx = 30,bg="pink",fg="black", pady = 20,command=lambda:cetak(8))
btn9  = Button(root,text="9",padx = 30,bg="grey",fg="black", pady = 20,command=lambda:cetak(9))
btn0  = Button(root,text="0",padx = 30,bg="cyan",fg="black", pady = 20,command=lambda:cetak(0))
...
hap = Button(root,text="Clr",padx = 30,bg="#878787",fg="white", pady = 20,command=hapus)
equal = Button(root,text="=",padx = 60,bg="skyblue",fg="white", pady = 20,command=samadengan)

#tampilanmainmenuangka
